  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 border">
          <div className="flex items-center justify-between w-full px-4 py-2">
            <div className="flex items-center gap-3">
              ...
              <h1 className="font-semibold text-base">Welcome {name}</h1>
            </div>

            <div className="flex items-center gap-4 ">
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-0 w-full max-w-md overflow-hidden rounded-md border border-input bg-muted">
                <div className="hidden lg:block w-32">
                  <Select>
                    <SelectTrigger className="w-full border-0 rounded-none bg-transparent">
                ...
                <div className="relative flex-1">
                  <Input
                    type="text"
                    placeholder="Search..."
                    className="text-sm border-0 bg-white focus-visible:ring-0 w-full rounded-none"
                  />
                  <Search className="absolute right-3 top-1/2 -translate-y-1/2 h-4 text-muted-foreground cursor-pointer" />
                </div>
              </div>
        ...
        <h2 className="ml-5 mt-5 font-medium">QUICK ACCESS</h2>
        ...
        <section className="max-w-6xl w-full mx-auto space-y-6 px-6 py-4">
          <div className="flex justify-start bg-muted border rounded-lg p-6 w-full max-w-[700px]">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <Button variant="outline" className="h-28 w-52 flex gap-4">
